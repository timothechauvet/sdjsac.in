...
const MINOR_DONORS = [
  ...
  { nameKn: "ಜಿನದತ್ತ ಜೈನ್ ಕಳ್ಳುಮನೆ", nameEn: "Jinadatta Jain, Kallumane", amount: "₹ 6,000" },
  { nameKn: "ಅಶೋಕ A.B ಅಡಗಳಲೆ", nameEn: "Ashoka A.B, Adagalale", amount: "₹ 6,100" },
  { nameKn: "ಧನಪಾಲ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Dhanapala Jain, Adagalale", amount: "₹ 5,000" },
  { nameKn: "ಚಂದಯ್ಯ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Chandayya Jain, Adagalale", amount: "₹ 5,000" },
  { nameKn: "ದಾಕಪ್ಪ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Dakappa Jain, Adagalale", amount: "₹ 5,000" },
  { nameKn: "ಶಿಶುಪಾಲ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Shishupala Jain, Adagalale", amount: "₹ 5,000" },
  { nameKn: "ಪದ್ಮರಾಜ A.N ಅಡಗಳಲೆ", nameEn: "Padmaraja A.N, Adagalale", amount: "₹ 5,000" },
  { nameKn: "ಸುರೇಶ್ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Suresh Jain, Adagalale", amount: "₹ 5,000" },
  { nameKn: "ನೇಮಯ್ಯ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Nemayya Jain, Adagalale", amount: "₹ 5,000" },
  { nameKn: "ಮಮತಾ ಮಹಾವೀರ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Mamatha Mahaveera Jain, Adagalale", amount: "₹ 5,000" },
  { nameKn: "ಸುಹಾಸಿನಿ ಜೈನ್ ಮಿಲನ ಬೆಂಗಳೂರು", nameEn: "Suhasini Jain, Milana Bengaluru", amount: "₹ 5,000" },
  { nameKn: "ಜಿನೇಂದ್ರ ಹಳ್ಳಿ", nameEn: "Jinendra, Halli", amount: "₹ 5,000" },
  { nameKn: "ಜ್ಯೋತಿ ವಿನೋದ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Jyothi Vinoda Jain, Adagalale", amount: "₹ 5,000" },
  { nameKn: "ಸವಿತಾ ವೃಷಭರಾಜ್ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Savitha Vrishabharaj Jain, Adagalale", amount: "₹ 5,000" },
  { nameKn: "ಶ್ರೀರತ್ನ ಪವನಕುಮಾರ್ ಮಂಗಳೂರು", nameEn: "Sreerathna Pavanakumar, Mangaluru", amount: "₹ 5,108" },
  { nameKn: "ವಿಜಯಕುಮಾರ್ ಕೂಡನಹಳ್ಳಿ", nameEn: "Vijayakumar, Koodanahalli", amount: "₹ 5,108" },
  { nameKn: "ವಿಜಯೇಂದ್ರ ಜೈನ್ ಚಕ್ಕೋಡು", nameEn: "Vijayendra Jain, Chakkodu", amount: "₹ 5,108" },
  { nameKn: "ದ್ಯಾವಮ್ಮ ಪದ್ಮಯ್ಯ ಜೈನ್ ಮತ್ತಲಗೋಡು", nameEn: "Dyavamma Padmayya Jain, Mattalagodu", amount: "₹ 5,108" },
  { nameKn: "ಆರತಿ ಉದಯಕುಮಾರ್ ಜೈನ್ ಕೊಗಾರು", nameEn: "Aarathi Udayakumar Jain, Kogaru", amount: "₹ 5,108" },
  { nameKn: "ವಿಮಲ್ ಕುಮಾರ್ ಜೈನ್ ಮುರಾರಿ", nameEn: "Vimal Kumar Jain, Murari", amount: "₹ 5,108" },
  { nameKn: "ಶಿಶುಪಾಲ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Shishupala Jain, Adagalale", amount: "₹ 5,108" },
  { nameKn: "ದಾಕಪ್ಪ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Dakappa Jain, Adagalale", amount: "₹ 5,108" },
  { nameKn: "ಯಶೋಧ ಭರತರಾಜ್ ಕುಟುಂಬದವರು ಶಂಸೆ", nameEn: "Yashodha Bharatharaj Family, Shamse", amount: "₹ 3,108" },
  { nameKn: "ಮಂಜಯ್ಯ A.P ಅಡಗಳಲೆ", nameEn: "Manjayya A.P, Adagalale", amount: "₹ 3,000" },
  { nameKn: "ಪುಟ್ಟಸ್ವಾಮಿ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Puttaswamy Jain, Adagalale", amount: "₹ 3,000" },
  { nameKn: "ಪದ್ಮಯ್ಯ (ರವಿ) ಅಡಗಳಲೆ", nameEn: "Padmayya (Ravi), Adagalale", amount: "₹ 3,000" },
  { nameKn: "ಅಶೋಕ ಜೈನ್ A.B ಅಡಗಳಲೆ", nameEn: "Ashoka Jain A.B, Adagalale", amount: "₹ 3,000" },
  { nameKn: "ಪುಟ್ಟಸ್ವಾಮಿ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Puttaswamy Jain, Adagalale", amount: "₹ 3,000" },
  { nameKn: "ಯಶೋಧ ಭರತರಾಜ್ ಕುಟುಂಬದವರು ಶಂಸೆ", nameEn: "Yashodha Bharatharaj Family, Shamse", amount: "₹ 3,000" },
  { nameKn: "A.J ಚೂಡಾರತ್ನ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "A.J Choodaratna Jain, Adagalale", amount: "₹ 2,500" },
  { nameKn: "ನೀಲಕುಮಾರ್ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Neelakumar Jain, Adagalale", amount: "₹ 2,500" },
  { nameKn: "ಸ್ಫೂರ್ತಿ, ಕೀರ್ತಿ ಅಡಗಳಲೆ", nameEn: "Spoorthi, Keerthi, Adagalale", amount: "₹ 2,030" },
  { nameKn: "ಜಿನದತ್ತ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Jinadatta Jain, Adagalale", amount: "₹ 2,000" },
  { nameKn: "ಚೂಡಾರತ್ನ A.N ಅಡಗಳಲೆ", nameEn: "Choodaratna A.N, Adagalale", amount: "₹ 2,000" },
  { nameKn: "ಜ್ಯೋತಿ ವಿನೋದ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Jyothi Vinoda Jain, Adagalale", amount: "₹ 2,000" },
  { nameKn: "ಸೋಮು ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Somu Jain, Adagalale", amount: "₹ 2,000" },
  { nameKn: "ದ್ಯಾವಪ್ಪ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Dyavappa Jain, Adagalale", amount: "₹ 2,000" },
  { nameKn: "ಪುಟ್ಟಸ್ವಾಮಿ ಜೈನ್ ಚಂದೊಳ್ಳಿ", nameEn: "Puttaswamy Jain, Chandolli", amount: "₹ 2,000" },
  { nameKn: "ಶಾಂತರಾಜ್ ಜೈನ್ ಯಲದಮಕ್ಕಿ", nameEn: "Shantharaj Jain, Yaladamakki", amount: "₹ 2,000" },
  { nameKn: "ನರೇಂದ್ರ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Narendra Jain, Adagalale", amount: "₹ 1,500" },
  { nameKn: "ಜ್ಯೋತಿ ವಿನೋದ ಅಡಗಳಲೆ", nameEn: "Jyothi Vinoda, Adagalale", amount: "₹ 1,010" },
  { nameKn: "ಯಶೋಧ ಭರತರಾಜ್ ಕುಟುಂಬದವರು ಶಂಸೆ", nameEn: "Yashodha Bharatharaj Family, Shamse", amount: "₹ 1,008" },
  { nameKn: "ಪದ್ಮರಾಜ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Padmaraja Jain, Adagalale", amount: "₹ 1,000" },
  { nameKn: "ವೃಷಭರಾಜ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Vrishabharaja Jain, Adagalale", amount: "₹ 1,000" },
  { nameKn: "ರತ್ನಮ್ಮ ಅಡಗಳಲೆ", nameEn: "Ratnamma, Adagalale", amount: "₹ 1,000" },
  { nameKn: "ಕಾಂತರಾಜ ಜೈನ್ ಚಂದೊಳ್ಳಿ", nameEn: "Kantharaja Jain, Chandolli", amount: "₹ 1,000" },
  { nameKn: "ಶಿಶುಪಾಲ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Shishupala Jain, Adagalale", amount: "₹ 1,000" },
  { nameKn: "ಸವಿತಾ ವೃಷಭರಾಜ ಜೈನ್ ಅಡಗಳಲೆ", nameEn: "Savitha Vrishabharaja Jain, Adagalale", amount: "₹ 508" },
  { nameKn: "ಸುಧಾ ಅಡಗಳಲೆ", nameEn: "Sudha, Adagalale", amount: "₹ 500" },
  { nameKn: "ಜಯಕುಮಾರ್ ಜೈನ್ ರೊಟ್ಟಿಹಳ್ಳಿ", nameEn: "Jayakumar Jain, Rottihalli", amount: "₹ 100" },
];
